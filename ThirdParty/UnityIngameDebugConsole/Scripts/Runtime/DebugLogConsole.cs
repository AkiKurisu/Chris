...
namespace Chris.RuntimeConsole
{
	...
	public static class DebugLogConsole
	{
		...
		private static void ResetStatics()
		{
			...
			// Initialize Console Variables from Chris Config system
		...
		/// Initialize console variables from Chris Config system
		/// </summary>
		private static void InitializeConsoleVariables()
		{
			try
			{
				...
				{
					RegisterConsoleVariable(variable);
				}
			}
			catch (Exception ex)
			{
				Debug.LogError($"[Chris] Failed to initialize console variables: {ex.Message}");
			}
		}
		...
		private static void RegisterConsoleVariable(ConsoleVariable variable)
		{
			...
			{
				Debug.LogError($"[Chris] Failed to register console variable {variableName}: {ex.Message}");
			}
		}
